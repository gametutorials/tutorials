...
//		$Program:	Singleton						
//											
//		$Description:	Explains what a singleton is and how to make one
//											
//**********************************************************************************//

Files:  	main.cpp (The source file containing the actual code)
		errorLog.cpp (The source file containing the "singleton's implementation")
		errorLog.h (The header file containing the "singleton's definitions")
		Singleton.vcxproj  (The VC++ project file holding the project info)
		Singleton.sln  (The solution file holding the solution info)
