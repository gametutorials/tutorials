...
Files:  	main.cpp (The source file containing the actual code)
		list.cpp (The source file containing the "linked list implementation")
		list.h (The header file containing the "linked list definition")
		LinkedList.vcxproj  (The VC++ project file holding the project info)
		LinkedList.sln  (The solution file holding the solution info)
