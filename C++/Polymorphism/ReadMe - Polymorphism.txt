...
Files:  	main.cpp (The source file containing the actual code)
		Shape.cpp (The source file containing the "shape class's implementations")
		Shape.h (The header file containing the "shape class's definitions")
		Polymorphism.vcxproj  (The VC++ project file holding the project info)
