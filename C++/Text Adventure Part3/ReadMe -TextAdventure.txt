...
//											
//		$Program:	TextureAdventure						
//											
//		$Description:	This shows how add and fight monsters in the game
//
//**********************************************************************************//

Files:  	Main.cpp (The Source File containing the actual code)
		TextAdventure.vcxproj  (The VC++ Project File holding the project info)
		TextAdventure.sln  (The Solution File holding the solution info)
		World.txt (The Text File containg the text adventure script)
