...
//		$Program:	Classes						
//											
//		$Description:	Explains classes (Part 4 of 5) 
//											
//**********************************************************************************//

Files:  	main.cpp (The source file containing the actual code)
		string_obj.cpp (The source file containing the string object implementation)
		string_obj.h (The header file containing the sting object definition)
		Classes.vcxproj  (The VC++ project file holding the project info)
