...
Files:  	Main.cpp (The Source File containing the main program code)
		...
		ShadersTexturing.vcxproj  (The VC++ Project File holding the project info)
		ShadersTexturing.sln  (The Solution File holding the solution info)
		MultiTexturing.vert (The vertex shader text file)
		MultiTexturing.frag (The pixel/fragment shader text file)
		Background and Fog.bmp (The Bitmap Files used by this tutorial)
