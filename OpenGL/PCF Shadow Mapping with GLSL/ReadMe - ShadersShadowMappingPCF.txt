...
Files:  	Main.cpp (The Source File containing the main program code)
		...
		ShadowMappingPCF.vcxproj  (The VC++ Project File holding the project info)
		ShadowMappingPCF.sln  (The Solution File holding the solution info)
		ShadowMappingPCF.vert (The vertex shader text file)
		ShadowMappingPCF.frag (The pixel/fragment shader text file)
		NoShadows.jpg (A picture showing no self-shadowing)
		ShadowsOnTexture.jpg (A picture showing self-shadowing on a texture mapped object)
