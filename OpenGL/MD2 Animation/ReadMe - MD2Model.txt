...
//		$Program:	MD2Model
//
//		$Description:	Demonstrates how to animate Quake2 .Md2 file with key frame animation	
//											
//***********************************************************************
...
Files:  	Main.cpp (The Source File containing the main program code)
		...
		MD2Model.vcxproj  (The VC++ Project File holding the project info)
		MD2Model.sln  (The Solution File holding the solution info)
		knight.MD2 (The MD2 model)
		knight.bmp (The Bitmap File that is the texture map for the MD2 model)
