...
Files:  	Main.cpp (The Source File containing the main program code)
		...
		MD3Model.vcxproj  (The VC++ Project File holding the project info)
		MD3Model.sln  (The Solution File holding the solution info)
		Elf Folder (The Directory holding all the MD3 model/texture files)
