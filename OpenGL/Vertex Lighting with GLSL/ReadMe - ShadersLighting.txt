...
//										
//		$Description:	We use GLSL to create easy vertex lighting			 
//									 
//***********************************************************************
...
Files:  	Main.cpp (The Source File containing the main program code)
		...
		ShadersLighting.vcxproj  (The VC++ Project File holding the project info)
		ShadersLighting.sln  (The Solution File holding the solution info)
