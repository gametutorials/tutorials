...
Files:  	Main.cpp (The Source File containing the main program code)
		...
		ShadersLightingII.vcxproj  (The VC++ Project File holding the project info)
		ShadersLightingII.sln  (The Solution File holding the solution info)
		LightingII.vert (The vertex shader text file)
		LightingII.frag (The pixel/fragment shader text file)
