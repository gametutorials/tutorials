...
Files:  	Main.cpp (The Source File containing the main program code)
		...
		MD2.cpp (The Source File containing the code for the CLoadMD2 class)
		MD2.h (The Header File containing definitions for the CLoadMD2 class)
		ShadersToon.vcxproj  (The VC++ Project File holding the project info)
		ShadersToon.sln  (The Solution File holding the solution info)
		ToonShading.vert (The vertex shader text file)
		ToonShading.frag (The pixel/fragment shader text file)
		Knight.Md2 (The model for our demo)
