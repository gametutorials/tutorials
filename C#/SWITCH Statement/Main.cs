...
// Create our class entitled "SwitchStatement" for our program
class SwitchStatement
{
    ...
    static void Main()
    {
        ...
        Console.Write("Input a number between 1 and 3: ");
        ...
        {										// The beginning of the switch statements scope
            case 1:								// If number equals 1, say so
                Console.WriteLine("You typed in the number 1!");
                break;							// Stop this and leave the switch statement

            case 2:								// If number equals 2, say so
                Console.WriteLine("You typed in the number 2!");
                break;							// break out of the switch statement

            case 3:								// If number equals 3, say so
                Console.WriteLine("You typed in the number 3!");
		...
		// the "\n" characters twice in the beginning of our string.  Remember
		// that this stands for "new line" and it will move the cursor down
		// two lines from the previous text printed out to the console window.								
        Console.Write("\n\nInput a character: ");

        // Now we will use a different function to get input from the user.
        // ReadKey() returns a single character that the user hits.  We
        // create a variable of type "char" that just stores one character like
        // a 'z' or 'w'.  For simplicity we call the variable "ch".  Remember
        // that a "string" is really an "array" of characters.  We will get
        // more into arrays in a future tutorial.
        //
        // Let's discuss a couple things about using ReadKey() first, since
        // you will notice that there is a ".KeyChar" after the function.
        // The ReadKey() function returns an object of type "ConsoleKeyInfo"
        // that has some functions and variables inside of it.  We will just
        // talk about the "KeyChar" character.  That is the value of type "char"
        // that we want to get.  Also, when using ReadKey() we don't need to
        // hit enter for the function to process.  Once the user types a key
        // on the keyboard it will return that key to us.
...
//
// Otherwise, switch statements are great!  Try some for yourself.
//
// One last note on what we did with ReadKey().  We did this:
//
// char ch = Console.ReadKey().KeyChar;
//
...
// 
// So basically, instead of storing the ConsoleKeyInfo object in a variable and then
// using it, C++/C# allows you to just skip that step and then access the variable
// from the function that returns the object by using another '.' operator.  If this
// seems confusing just wait until we get to classes and you will start to understand.
//
//
