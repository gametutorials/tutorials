...
// Create our class entitled "Functions" for our program
class Functions
{
    ...
    static void Main()
    {
        ...
        while (bStillPlaying)					
        {
            ...
            Console.Write("Choose from the menu: ");	// Prompt the user

            string strChoice = Console.ReadLine();		// Get the user's choice
            ...
            switch (choice)
            {
                case 1: Console.WriteLine("You chose a New Game!");		// if (choice == 1) print a message
                    break;					                            // "break" breaks out of the switch statement 
                case 2: Console.WriteLine("You chose to Load a Game!");	// if (choice == 2)
                    break;									            // Print the choice and break
                case 3: Console.WriteLine("You chose to Save a Game!");	// if (choice == 3)
                    break;									            // Print the choice and break
                case 4: Console.WriteLine("You chose your Inventory!");	// if (choice == 4)
                    break;									            // Print the choice and break
                case 5: Console.WriteLine("You chose Options!");        // if (choice == 5)
                    break;									            // Print the choice and break
                case 6:
                    ...
                    Console.WriteLine("Game over already?");            // Print out the game over message
