...
//		$Program:	Midi
//						 
//		$Description:	Shows how to play .midi files using MCI	 
//										 
//***********************************************************************

Files:  	win_main.cpp (The Source File containing the main window code)
		Midi.cpp (The Source File containing the MIDI class implementation)
		Midi.h (The Header File containing the MIDI class definition)
		Midi.vcxproj  (The VC++ Project File holding the project info)
		Midi.sln  (The Solution File holding the solution info)
		win_bkgrd.bmp (The Bitmap File displayed as the window's background image)
		MidiMusic.mid (The MIDI File for being played)
