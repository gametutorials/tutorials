...
Files:  	win_main.cpp (The Source File containing the main window code)
	...
	tgaLoader.vcxproj  (The VC++ Project File holding the project info)
	tgaLoader.sln  (The Solution File holding the solution info)
	GameTutorials_24.tga (A Targa File for displaying)
	GameTutorials_32.tga (A Targa File for displaying)
