...
//										
//		$Description:	Creates a dialog pox that asked for a password to continue
//										
//**********************************************************************************//

Files:  	DialogBoxes.cpp (The Source File containing the main window code)
	resource.h (The Header File containing resource definitions)
	DialogBoxes.rc (The Resoure File containing the dialog box resource)
	DialogBoxes.vcxproj  (The VC++ Project File holding the project info)
	DialogBoxes.sln  (The Solution File holding the solution info)
