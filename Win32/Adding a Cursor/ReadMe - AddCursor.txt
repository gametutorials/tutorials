...
//		$Program:		AddCursor				
//										
//		$Description:	Shows how to add a cursor to an application
//										
//**********************************************************************************//

Files:  	win_main.cpp (The Source File containing the main window code)
	resource.h (The Header File containing resouce defintions)
	AddCursor.rc (The Resoure File containing the cursor resource)
	AddCursor.vcxproj  (The VC++ Project File holding the project info)
	AddCursor.sln  (The Solution File holding the solution info)
	arrow.cur (The Cursor File)
