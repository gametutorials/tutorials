...
//		$Program:	AddIcon				
//										
//		$Description:	Shows how to add a icon to an application
//										
//**********************************************************************************//
...
Files:  	win_main.cpp (The Source File containing the main window code)
		...
		AddIcon.rc (The Resoure File containing the cursor resource)
		AddIcon.vcxproj  (The VC++ Project File holding the project info)
		AddIcon.sln  (The Solution File holding the solution info)
		icon1.ico (The Icon File)
