...
//		$Program:	Drawing			 
//										 
//		$Description:	Draws rectangles to a window using HBRUSHs 
//											
//***********************************************************************

Files:  	win_main.cpp (The source file containing the main window code)
		Drawing.vcxproj  (The VC++ project file holding the project info)
		Drawing.sln  (The solution file holding the solution info)
