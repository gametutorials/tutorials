...
//		$Program:		Dialog
//		
//		$Description:	A tutorial on dialog boxes
//
//*********************************************************************************//

Files:  	win_main.cpp (The Source File containing the main window code)
	resource.h (The Header File containing the resource definitions)
	dbox.rc (The Resoure File containing the window's dialog box resource)
	Dialog.vcxproj  (The VC++ Project File holding the project info)
	Dialog.sln  (The Solution File holding the solution info)
