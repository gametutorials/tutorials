...
//										
//		$Program:		Text				
//											//		$Description:	Draw's "Hello World!" using red text
//										
//**********************************************************************************//

Files:  	Text.cpp (The Source File containing the main window code)
	Text.vcxproj  (The VC++ Project File holding the project info)
	Text.sln  (The Solution File holding the solution info)
