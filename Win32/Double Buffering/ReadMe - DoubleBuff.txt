...
//		$Program:		DoubleBuff
//
//		$Description:	Goes over "double buffering"
//
//*********************************************************************************//

Files:  	win_main.cpp (The Source File containing the main window code)
	DoubleBuff.vcxproj  (The VC++ Project File holding the project info)
	DoubleBuff.sln  (The Solution File holding the solution info)
	AnImage.bmp (The Bitmap File to be displayed)
