...
//		$Program:		FullScreen
//										
//		$Description:	Changes to full screen (and back) dynamically
//										
//**********************************************************************************//
...
Files:  	win_main.cpp (The Source File containing the main window code)
	...
	MenuScript.rc (The Resource File containing the menu)
	FullScreen.vcxproj  (The VC++ Project File holding the project info)
