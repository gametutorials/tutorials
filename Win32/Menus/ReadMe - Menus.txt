...
Files:  	Menu.cpp (The Source File containing the main window code)
		resource.h (The Header File containing resouce defintions)
		Menu.rc (The Resoure File containing the menu resource)
		Menus.vcxproj  (The VC++ Project File holding the project info)
		Menus.sln  (The Solution File holding the solution info)
