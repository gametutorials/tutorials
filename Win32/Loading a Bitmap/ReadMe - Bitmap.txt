...
//		$Program:		Bitmap							
//											
//		$Description:	Loads a bitmap plain and simple 
//											
//***********************************************************************

Files:  	win_main.cpp (The Source File containing the main window code)
	Bitmap.vcxproj  (The VC++ Project File holding the project info)
	Bitmap.sln  (The Solution File holding the solution info)
	MyBitmap.bmp (The Bitmap File for displaying)
