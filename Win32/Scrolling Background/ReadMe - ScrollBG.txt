...
//		$Program:		ScrollBG			 
//											
//		$Description:	Shows how to create a scrolling background 
//											
//*******************************************************************************
...
Files:  	win_main.cpp (The Source File containing the main window code)
	...
	ScrollBG.vcxproj  (The VC++ Project File holding the project info)
	ScrollBG.sln  (The Solution File holding the solution info)
	background.bmp (The Bitmap File representing the scrolling background image)
