...
//		$Program:		TextBlitter				
//										
//		$Description:	Blits a text to the screen using a "bitmap font"
//										
//**********************************************************************************//
...
Files:  	win_main.cpp (The Source File containing the main window code)
	...
	win_main.h (The Header File containing the "text blitter" definitions) 
	TextBlitter.vcxproj  (The VC++ Project File holding the project info)
	TextBlitter.sln  (The Solution File holding the solution info)
