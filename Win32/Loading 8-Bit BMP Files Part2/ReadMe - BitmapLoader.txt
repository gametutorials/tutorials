...
//										
//		$Program:		BitmapLoader				
//										
//		$Description:	Loads 8-bit, uncompressed or compressed BMP files
//										
//**********************************************************************************//

Files:  	win_main.cpp (The Source File containing the main window code)
	bitmap_class.cpp (The Source File containing the bitmap class implementation)
	bitmap_class.h (The Header File containing the bitmap class definition)
	BitmapLoader.vcxproj  (The VC++ Project File holding the project info)
	BitmapLoader.sln  (The Solution File holding the solution info)
	Image8Bit.bmp (A Bitmap File for being displayed)
	CompressedImage8Bit.bmp (A Bitmap File for being displayed)
