...
//		$Program:		PCX_Loader				
//										
//		$Description:	Loads 8-bit and 24-bit .pcx files
//										
//**********************************************************************************//

Files:  	win_main.cpp (The Source File containing the main window code)
	bitmap_class.cpp (The Source File containing the bitmap class/pcx loading implementation)
	bitmap_class.h (The Header File containing the bitmap class definitions)
	PCX_Loader.vcxproj  (The VC++ Project File holding the project info)
	PCX_Loader.sln  (The Solution File holding the solution info)
	Image8Bit.pcx (A PCX File for displaying)
	Image24Bit.pcx (A PCX File for displaying)
