...
//										
//		$Description:	Using DIB Sections we create TransparentBlit()
//										
//**********************************************************************************//

Files:  	Main.cpp (The Source File containing the main window code)
	Bitmap.cpp (The Source File containing the "bitmap code")
	Sprite.cpp (The Source File containing the main "sprite code")
	Sprite.h (The Header File containing sprite definitions)
	Bitmap.h (The Header File containing bitmap definitions)
	Main.h (The Header File containing window definitions)
	Transparency.vcxproj  (The VC++ Project File holding the project info)
	Transparency.sln  (The Solution File holding the solution info)
	background.bmp (The Bitmap File that is the window's background)
	monster.bmp (The Bitmap File that is contains the character's animations)
