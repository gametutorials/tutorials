...
//		$Program:		HDC					 
//										 
//		$Description:	Talks about a Handle to a Device Context
//											
//*******************************************************************************/

Files:  	win_main.cpp (The Source File containing the main window code)
	HDC.vcxproj  (The VC++ Project File holding the project info)
	HDC.sln  (The Solution File holding the solution info)
