...
//		$Program:		EditBox
//										
//		$Description:	A VERY WATERED DOWN version of NotePad
//										
//**********************************************************************************//
...
Files:  	win_main.cpp (The Source File containing the main window code)
	...
	Resources.rc (The Resource File containing the menu resource)
	EditBox.vcxproj  (The VC++ Project File holding the project info)
	EditBox.sln  (The Solution File holding the solution info)
	OutFile.txt (The Text File that is loaded from and saved to)
