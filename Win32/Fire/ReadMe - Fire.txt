...
Files:  	Main.cpp (The Source File containing the main window code)
	...
	Bitmap.h (The Header File containing the bitmap definitions)
	Main.h (The Header File containing window definitions)
	Fire.vcxproj  (The VC++ Project File holding the project info)
	Fire.sln  (The Solution File holding the solution info)
