...
//										
//		$Program:		Display Bitmaps (Double Buffering)			
//										
//		$Description:	Uses double buffering to display bitmaps
//										
//**********************************************************************************//

Files:  	DisplayBitmaps.cpp (The Source File containing the main window code)
	Bitmap.cpp (The Source File containing the "bitmap code")
	Bitmap.h (The Header File containing "bitmap definitions")
	DisplayBitmap.h (The Header File containing window definitions)
	DisplayBitmaps.vcxproj  (The VC++ Project File holding the project info)
	DisplayBitmaps.sln  (The Solution File holding the solution info)
	Bitmap.bmp (The Bitmap File to be displayed)
	Bitmap2.bmp (Another Bitmap File to be displayed)
