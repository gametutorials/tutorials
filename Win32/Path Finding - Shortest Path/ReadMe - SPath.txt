...
//		$Program:		SPath			 
//											
//		$Description:	Talks about a "shortest-path" algorithm 
//											
//*******************************************************************************
...
Files:  	win_main.cpp (The Source File containing the main window code)
	...
	grid.cpp (The Source File containg the "grid object" implementation)
	cell.h (The Header File containing the definition and implementatin the "cell object")
	grid.h (The Header File containing the "grid object" definition)
	winobj.h (The Header File containing the window object definition) 
	SPath.vcxproj  (The VC++ Project File holding the project info)
	SPath.sln  (The Solution File holding the solution info)
