...
//		$Program:	ScrollBar				
//										
//		$Description:	Goes over the vertical scroll bar 
//										
//**********************************************************************************//

Files:  	win_main.cpp (The source file containing the main window code)
		ScrollBar.vcxproj  (The VC++ project file holding the project info)
		ScrollBar.sln  (The solution file holding the solution info)
