...
//		$Program:		Mouse				 
//										 
//		$Description:	Goes over the mouse buttons and wheel
//											
//*******************************************************************************/

Files:  	win_main.cpp (The Source File containing the main window code)
	Mouse.vcxproj  (The VC++ Project File holding the project info)
	Mouse.sln  (The Solution File holding the solution info)
