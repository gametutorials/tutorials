...
//		$Program:		KeyInput		 
//										 
//		$Description:	Teaches how to get keyboard input outside of the WinProc
//											
//*****************************************************************************************/

Files:  	win_main.cpp (The Source File containing the main window code)
	input.cpp (The Source File containing the input code)
	input.h (The Header File containing the input definitions)
	KeyInput.vcxproj  (The VC++ Project File holding the project info)
	KeyInput.sln  (The Solution File holding the solution info)
