...
//										
//		$Description:	This creates a bitmap pattern in the background
//										
//**********************************************************************************//

Files:  	BitmapBackground.cpp (The Source File containing the main window code)
	BitmapBackground.vcxproj  (The VC++ Project File holding the project info)
	BitmapBackground.sln  (The Solution File holding the solution info)
