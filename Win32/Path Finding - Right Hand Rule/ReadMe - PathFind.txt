...
//		$Program:		PathFind
//
//		$Description:	A tutorial on the "right hand rule"
//
//*********************************************************************************//
...
Files:  	win_main.cpp (The Source File containing the main window code)
	...
	path.cpp (The Source File containing the path finding implementation)
	DIB_Bitmap.cpp (The Source File containing the bitmap implementation)
	DIB_Bitmap.h (The Header File containing the bitmap definitions)
	path.h (The Header File containing path finding function definitions)
	winobj.h (The Header File containing the window object definition)
	PathFind.vcxproj  (The VC++ Project File holding the project info)
	PathFind.sln  (The Solution File holding the solution info)
	Tile1 - 4.bmp (The Bitmap Files that are the tiles on the "map")
