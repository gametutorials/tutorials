...
Files:  	LoadAJpeg.java (The source file containing the actual code)
		GTCube.jpg (The jpeg file that is displayed in the applet)
		LoadAJpeg.html (A web page that runs the applet in a browser)
