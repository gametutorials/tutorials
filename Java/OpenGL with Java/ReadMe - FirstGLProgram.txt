...
//									
//		$Program:	FirstGLProgram
//									
//		$Description:	This draws a 3D triangle using OpenGL (jogl)
//									
//***********************************************************************//

Files:  	GLApplet.java (The source file for handling the applet)
		OpenGL.java (The code for handling handling and drawing with OpenGL)
		GLApplet.html (A web page that runs the applet in a browser)
...
Instructions:	If you have NetBeans you will need to open the program and then
		...
		Be sure to put the jogl .dlls in the bin/ folder of your JRE
		directory, as well as the jogl .jar files in the ext/ dir of JRE.
