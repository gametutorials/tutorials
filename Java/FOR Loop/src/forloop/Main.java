...
// Import the Scanner class for nextInt()
import java.util.Scanner;

// Create our Main class for the program
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        for (i = min; i <= max; i++)	
        {
            ...
            // The println() function can not only take a string to print, but also many
            // other types like a integer, float, double or a single character (char).
...
// most other things in Java/C/C++/C# so it's a weird site at first.  Basically, what
