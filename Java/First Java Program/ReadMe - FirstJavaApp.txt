...
Files:  	Main.java (The source file containing the actual code)
...
Instructions:	If you have NetBeans you will need to open the program and then
		...
		and then right click on it and choose "Run File".
...
FAQ:		PLEASE READ THE GT FAQ ON THE CD BEFORE ANYTHING ELSE.  This
		answers all the frustrating questions about Java that you will
		probably encounter when trying to get things setup.
