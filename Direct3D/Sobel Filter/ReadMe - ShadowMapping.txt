...
//						 
//		$Description:	Shows how to implement "Shadow Mapping"
//											 
//*********************************************************************************//
...
Files:		win_main.cpp (Source file containing the "window" code)
		...
		d3d_texture.cpp (Source file containing the "D3D texture" code)
		d3d_rendertarget.cpp (Source file containing the "D3D render target" code)
		vector.cpp (Source file containing the 3D vector code)
		vector.h (Header file containing the 3D vector class definition)
		d3d_rendertarget.h (Header file containing the "D3D render target" definitions)
