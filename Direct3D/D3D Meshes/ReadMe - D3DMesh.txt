...
//		$Program:		D3DMesh
//						 
//		$Description:	Shows how to use ID3DXMesh objects
//										 
//*********************************************************************************//
...
Files:	win_main.cpp  (The Source File containing the "window" code)
	...
	D3DMesh.vcxproj  (The VC++ Project File holding the project info)
	D3DMesh.sln  (The Solution File holding the solution info)
