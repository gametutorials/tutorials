...
//		$Program:		PixelShader
//						 
//		$Description:	An introduction to D3D pixel shaders with effect files
//										 
//*********************************************************************************//
...
Files:	win_main.cpp  (Source File containing the "window" code)
	...
	PixelShader.fx (Effect File containing shader and effect implementation)
	PixelShader.vcxproj  (The VC++ Project File holding the project info)
	PixelShader.sln  (The Solution File holding the solution info)
	texture.jpg (The JPG file to be displayed) 
