...
//		$Program:	NormalMap
//						 
//		$Description:	A lesson on normal mapping with shaders 
//										 
//*********************************************************************************//
...
Files:		win_main.cpp (Source File containing the "window" code)
		...
		NormalMap.vcxproj (The VC++ Project File holding the project info)
		NormalMap.sln (The Solution File holding the solution info)
