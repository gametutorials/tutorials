...
//						 
//		$Description:	Shows how to do per-pixel lighting in a .fx file			
//										 
//*********************************************************************************//
...
Files:		win_main.cpp  (Source file containing the "window" code)
		...
		VertexShader.fx (Effect file containing shader and effect implementation)
		PerPixelLighting.vcxproj  (The VC++ project file holding the project info)
		PerPixelLighting.sln  (The solution file holding the solution info)
		lighting.jpg, (JPEG diagram)
