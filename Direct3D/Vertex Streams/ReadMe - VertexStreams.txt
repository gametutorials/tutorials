...
//										 
//		$Program:	VertexStreams
//						 
//		$Description:	An introduction to "vertex streams" in D3D
//											 
//*********************************************************************************//
...
Files:		win_main.cpp (Source file containing the "window" code)
		...
		d3d_texture.cpp (Source file containing the "D3D texture object" code)
		d3d_mesh.cpp (Source file containing the "D3D mesh object" code)
		d3d_mesh.h (Header file containing the mesh class definition)
		d3d_texture.h (Header file containing the D3D texture class definition) 
		...
		VertexStreams.vcxproj (The VC++ project file holding the project info)
		VertexStreams.sln (The solution file holding the solution info)
