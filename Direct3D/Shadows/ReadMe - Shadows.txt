...
//		$Program:	Shadows
//						 
//		$Description:	Goes over how to do planar shadows
//											 
//*********************************************************************************//
...
Files:		win_main.cpp (Source file containing the "window" code)
		...
		Shadows.vcxproj (The VC++ project file holding the project info)
		Shadows.sln (The solution file holding the solution info)
