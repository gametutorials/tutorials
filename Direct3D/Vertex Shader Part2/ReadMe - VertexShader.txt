...
//						 
//		$Description:	An introduction to D3D vertex shaders with effect files
//										 
//*********************************************************************************//
...
Files:	win_main.cpp  (Source File containing the "window" code)
	...
	VertexShader.vcxproj  (The VC++ Project File holding the project info)
	VertexShader.sln  (The Solution File holding the solution info)
